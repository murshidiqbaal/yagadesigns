        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-12 border-b border-white/5">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3 text-sm text-white/40 px-1 mt-1">
                <Phone className="w-4 h-4 text-[#D4AF37]/60" />
                <span>+91 98765 43210</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-white/40 px-1">
                <Instagram className="w-4 h-4 text-[#D4AF37]/60" />
                <span>@yagadesigns</span>
              </div>
            </div>
          </div>
        </div>
